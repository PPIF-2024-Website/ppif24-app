    ...
    return (
        <div className="flex justify-center h-auto w-screen bg-cover bg-[url('/ppif/images/timeline_bg.png')]">
            <div className="container min-h-screen w-100 text-white">
                <div className="whitespace-nowrap select-none pt-32 text-center text-[36px] sm:text-[68px] font-['Poppins'] drop-shadow-[0_0_12px_rgba(255,255,255,0.4)]">
                    <span className="font-semibold">Our </span>
                    <span className="font-black italic text-ppif-orange">TIMELINE</span>
                </div>

                <div className="mt-[58px] justify-items-center grid grid-cols-1 gap-x-10 gap-y-5 lg:grid-cols-3">
                    ...
                    >
                        <span className="font-[Poppins] font-black text-[32px] lg:text-5xl leading-7 drop-shadow-[0_0_6px_rgba(255,255,255,0.4)]">
                            BRIEFING<br/>DAY
                        </span>
                        ...
                        <span className="font-[Poppins] font-semibold text-base lg:text-xl mt-12">
                            see details
                        </span>
                    </div>
