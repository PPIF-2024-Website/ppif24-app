const days = [
    {
        ...
        description: `
            ...
            Informatika 2024. Pada hari briefing, kalian akan menerima berbagai materi 
            penting yang bermanfaat juga berkenalan dengan teman-teman lainnya. Ini adalah 
            langkah awal yang sangat penting untuk memastikan teman teman siap mengikuti 
    ...
    },
    {
        ...
        description: `
            ...
            karena untuk pertama kalinya kalian akan bertemu secara offline. Pada hari ini, kalian juga akan 
            bertemu dengan alumni Informatika UMN yang telah sukses di berbagai bidang. Ini akan menjadi 
            kesempatan emas untuk berjejaring dan berbincang langsung dengan para alumni yang siap berbagi 
    ...
    },
    {
        ...
        description: `
            ...
            semua materi yang telah diterima selama sesi pembekalan sebelumnya. Hari ini adalah waktu yang tepat 
            untuk mengekspresikan diri dan berkolaborasi dengan teman-teman semua dalam suasana yang dinamis dan mendukung. 
            HMIF Execution Time mendorong teman teman untuk membangun kepercayaan diri dan merasakan pengalaman langsung 
