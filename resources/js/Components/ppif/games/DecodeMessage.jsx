  ...
  return (
    <div className='flex flex-wrap gap-4 justify-between'>
        <form className="flex gap-4 md:w-[600px] w-full md:pt-6" onSubmit={handle_submit}>
            ...
            <button type="submit" className="text-white bg-white/20 backdrop-blur-lg font-medium rounded-[15px] md:text-lg w-[100px] text-center md:h-[40px] md:w-[150px] h-[40px]">Try</button>
        </form>
