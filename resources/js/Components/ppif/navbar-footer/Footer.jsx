...
function Footer() {
    ...
    return (
        <div className="relative">
            ...
            <div className="relative w-full h-auto bg-white bg-opacity-[40%] lg:bg-[#898085] lg:bg-opacity-100 py-5 before:absolute before:top-0 before:left-0 before:w-full before:h-3 before:bg-gradient-to-r before:from-[#8091ce] before:via-[#8091ce] before:to-[#8091ce] before:opacity-30">
                <div className="mx-auto flex flex-col items-center justify-between lg:flex-row z-10">
