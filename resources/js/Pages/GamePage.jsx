...
export default function Archives() {
    ...
    return (
        <>
            <ArchivesBackground />
            {response === null || response == "Group Invalid" ? (
                <>
                    <Modal title={"SECRET CODE"} isOpen={modalIsOpen}>
                        <form onSubmit={handleSubmit} className="relative flex h-full justify-center">
                            ...
                            <div className="absolute bottom-72 text-red-600 text-xl">
                                {response}
                            </div>
                            <button
                                type="submit"
                ...
                <>
                    <div className='h-screen w-screen'>
                        <div className='flex flex-col justify-center items-center h-screen'>
                            <h1 className='text-white text-center py-4 md:text-[30px] font-bold italic text-[36px] z-10'>DECODE THE MESSAGE</h1>
                            <HeaderDecodeMessage 
